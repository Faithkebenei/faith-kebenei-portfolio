        ...
        <div className={styles.header}>
            ...
            <div className={styles.links}>
                <ul className={styles.navlinks}>
                    <li><a onMouseEnter={() => handleHover(1)} onMouseLeave={() => handleUnHover(1)} id={1} style={{color: hovered && hoveredMenu === 1? "#FF7C36": "#fff"}} href="">Home</a></li>
                    <li><a onMouseEnter={() => handleHover(2)} onMouseLeave={() => handleUnHover(2)} id={2} style={{color: hovered && hoveredMenu === 2? "#FF7C36": "#fff"}} href="">About</a></li>
